        ...
        <div className="col-lg-6">
          <label className="radio-label">
            <input
              ...
              defaultChecked
              onChange={(e)=>{handleOptionChange(e); handleForm(e)}}
            />
            Home Collection
          </label>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <option value="option4">Body profile excutive - Female</option>
        ...
        <form onSubmit={handleSubmit} className="labAppointForm">
          ...
          <div className="row">
            ...
            <div className="col-lg-7">
              ...
              <input type="file" id="fileInput" name="fileInput"  />
              <button  onClick={handleClick} id="fileInputbtn" className="fileUpload">
                Preview
              </button>
            </div>
          </div>
